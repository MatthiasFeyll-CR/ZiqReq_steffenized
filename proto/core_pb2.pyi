...
class BrdDraftState(_message.Message):
    ...
    updated_at: str
    def __init__(self, idea_id: _Optional[str] = ..., sections: _Optional[_Mapping[str, str]] = ..., locked_sections: _Optional[_Mapping[str, bool]] = ..., updated_at: _Optional[str] = ...) -> None: ...
...
class FullChatHistoryRequest(_message.Message):
    ...
    IDEA_ID_FIELD_NUMBER: _ClassVar[int]
    idea_id: str
    def __init__(self, idea_id: _Optional[str] = ...) -> None: ...
...
class AiChatMessageRequest(_message.Message):
    __slots__ = ("idea_id", "content", "message_type", "language", "processing_id")
    IDEA_ID_FIELD_NUMBER: _ClassVar[int]
    CONTENT_FIELD_NUMBER: _ClassVar[int]
    MESSAGE_TYPE_FIELD_NUMBER: _ClassVar[int]
    ...
    language: str
    processing_id: str
    def __init__(self, idea_id: _Optional[str] = ..., content: _Optional[str] = ..., message_type: _Optional[str] = ..., language: _Optional[str] = ..., processing_id: _Optional[str] = ...) -> None: ...
...
class AiReactionRequest(_message.Message):
    __slots__ = ("idea_id", "message_id", "reaction_type")
    IDEA_ID_FIELD_NUMBER: _ClassVar[int]
    MESSAGE_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    message_id: str
    reaction_type: str
    def __init__(self, idea_id: _Optional[str] = ..., message_id: _Optional[str] = ..., reaction_type: _Optional[str] = ...) -> None: ...
...
class UpdateTitleRequest(_message.Message):
    __slots__ = ("idea_id", "new_title")
    IDEA_ID_FIELD_NUMBER: _ClassVar[int]
    NEW_TITLE_FIELD_NUMBER: _ClassVar[int]
    idea_id: str
    new_title: str
    def __init__(self, idea_id: _Optional[str] = ..., new_title: _Optional[str] = ...) -> None: ...
...
class UpdateBrdDraftRequest(_message.Message):
    ...
    def __init__(self, idea_id: _Optional[str] = ..., sections: _Optional[_Mapping[str, str]] = ..., readiness_evaluation_json: _Optional[str] = ...) -> None: ...
...
class IdeasByStateResponse(_message.Message):
    __slots__ = ("counts",)
...
class UserStatsResponse(_message.Message):
    __slots__ = ("idea_count", "review_count", "contribution_count")
    IDEA_COUNT_FIELD_NUMBER: _ClassVar[int]
    REVIEW_COUNT_FIELD_NUMBER: _ClassVar[int]
    CONTRIBUTION_COUNT_FIELD_NUMBER: _ClassVar[int]
    idea_count: int
    review_count: int
    contribution_count: int
    def __init__(self, idea_count: _Optional[int] = ..., review_count: _Optional[int] = ..., contribution_count: _Optional[int] = ...) -> None: ...
