...
class TestReviewActions(TestCase):
    ...
    def _url(self, action: str, project_id=None):
        return f"/api/projects/{project_id or self.project.id}/review/{action}"
    ...
    def test_accept_success(self):
        ...
        Input: POST /api/projects/:id/review/accept.
        ...
        assert self.project.state == "accepted"

        entry = ReviewTimelineEntry.objects.get(project_id=self.project.id, entry_type="state_change", new_state="accepted")
    ...
    def test_drop_success(self):
        ...
        Input: POST /api/projects/:id/review/drop with comment.
        ...
        self.project.refresh_from_db()
        assert self.project.state == "dropped"

        entry = ReviewTimelineEntry.objects.get(project_id=self.project.id, entry_type="state_change", new_state="dropped")
    ...
    def test_reject_success(self):
        ...
        Input: POST /api/projects/:id/review/reject with comment.
        ...
        self.project.refresh_from_db()
        assert self.project.state == "rejected"

        entry = ReviewTimelineEntry.objects.get(project_id=self.project.id, entry_type="state_change", new_state="rejected")
    ...
    def test_undo_accepted(self):
        ...
        Input: POST /api/projects/:id/review/undo with comment.
        ...
        entry = ReviewTimelineEntry.objects.filter(
            project_id=self.project.id, entry_type="state_change", new_state="in_review"
        ).last()
    ...
    def test_undo_invalid_state_in_review(self):
        """Undo on in_review project is invalid."""
    ...
    def test_api_review_06_accept_success(self):
        """API-REVIEW.06 | POST /api/projects/:id/review/accept | Success.
        Input: Valid in_review project.
    ...
    def test_api_review_07_reject_missing_comment(self):
        """API-REVIEW.07 | POST /api/projects/:id/review/reject | Missing comment.
    ...
    def test_api_review_08_drop_invalid_state(self):
        """API-REVIEW.08 | POST /api/projects/:id/review/drop | Invalid state.
    ...
    def test_api_review_09_undo_access_control(self):
        """API-REVIEW.09 | POST /api/projects/:id/review/undo | Access control.
    ...
    def test_timeline_records_states(self):
        ...
        entry = ReviewTimelineEntry.objects.get(project_id=self.project.id, entry_type="state_change")
        assert entry.old_state == "in_review"
