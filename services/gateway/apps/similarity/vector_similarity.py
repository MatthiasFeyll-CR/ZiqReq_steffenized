...
Mirrors services/core/apps/similarity/vector_similarity.py for test discoverability.
"""
...
# Raw SQL: for each recently-updated embedding, find other embeddings
# within the time window whose cosine similarity meets the threshold.
...
def vector_similarity_sweep() -> dict:
    ...
    # Build declined-pair set (both directions)
    ...
    # Execute cosine similarity query via pgvector
